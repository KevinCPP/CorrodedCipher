...
class Encryption_Menu:
    def __init__(self, widget_width=None):
        self.uief = UI_Element_Factory(widget_width)
        
        self.field1_label = "Algorithm"
        self.field1_tooltip = "Select an encryption algorithm to use"
        
        self.field2_label = "Input File"
        self.field2_tooltip = "Select the file you want to encrypt"

        self.field3_label = "Password"
        self.field3_tooltip = "Enter the password you want to encrypt with"

        self.field4_label = "Output destination"
        self.field4_tooltip = "Select the output destination where you want to save the encrypted file"

        self.dialog = None

    def create_menu_dialog(self):
        self.dialog = QDialog()
        self.dialog.setWindowTitle("Encryption Menu")
        
        self.layout = QVBoxLayout()
        
        options = interact.encryption_algos
        ...
        self.run_btn = self.uief.make_push_button_element(label="Encrypt", callback=self.run_encryption)
    ...
    def run_encryption(self):
        ...
        interact.encrypt(algo, file, password, output)
